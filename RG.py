...
#def app2():
    ...
    st.image(imagepot)
    st.write("Funcionamento do programa: Seguindo os comandos abaixo, você deverá inserir o valor do parâmetro de impacto (em unidades do raio gravitacional do corpo central). O programa então retornará um gráfico correspondente à trajetória da partícula com esse parâmetro de impacto, sendo $d≈5.196M$ o parâmetro de impacto crítico. Em (1) você pode explorar uma faixa definida de valores de  $d$ ; em (2), você pode inserir o valor desejado diretamente.")
