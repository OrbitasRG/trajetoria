...
#def app2():
    ...
    st.image(imagepot)
    st.write("Funcionamento do programa: Seguindo os comandos abaixo, você deverá inserir o valor do parâmetro de impacto (em unidades do raio gravitacional do corpo central). Você também pode escolher $d≈5.196M$, o valor do parâmetro de impacto crítico ($d=(V_{eff})^{-1/2}$). O programa então retornará um gráfico correspondente à trajetória da partícula com esse parâmetro de impacto. Em (1) você pode explorar uma faixa definida de valores de  $d$ ; em (2), você pode inserir o valor desejado diretamente.")
    ...
    d2 = st.number_input('Insira um valor de parâmetro de impacto',step=1e-3, format="%.3f")
